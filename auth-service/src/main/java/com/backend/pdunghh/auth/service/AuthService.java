...
import com.backend.pdunghh.auth.dto.request.ChangePasswordRequest;
import com.backend.pdunghh.auth.dto.request.DeactivateRequest;
import com.backend.pdunghh.auth.dto.request.LoginRequest;
import com.backend.pdunghh.auth.dto.request.RegisterRequest;
import com.backend.pdunghh.auth.dto.request.UserRequest;
import com.backend.pdunghh.auth.dto.response.LoginResponse;
import com.backend.pdunghh.auth.dto.response.RefreshResponse;
import com.backend.pdunghh.auth.dto.response.RegisterResponse;
import com.backend.pdunghh.auth.dto.response.UserResponse;
import com.backend.pdunghh.auth.entity.RefreshTokenEntity;
import com.backend.pdunghh.auth.entity.UserEntity;
import com.backend.pdunghh.auth.exception.AuthException;
import com.backend.pdunghh.auth.mapper.UserMapper;
import com.backend.pdunghh.auth.repository.RefreshTokenRepository;
import com.backend.pdunghh.auth.repository.UserRepository;
import com.backend.pdunghh.auth.security.AuthenticatedUser;
import com.backend.pdunghh.shared.api.dto.MessageResponse;
